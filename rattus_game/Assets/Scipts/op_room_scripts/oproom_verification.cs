    ...
    public class oproom_verification : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (lastClicked.name == "OpReport" && Conditions["OpenedMedRack"] && Conditions["LightOn"])
            {
                ...
                dialogue.AddSentence("Moi", "L'opération était une hémisphérectomie.", 7);
                dialogue.AddSentence("Moi", "C'est une opération qui consiste à enlever ou déconnecter une moitié du cerveau.", 7);
                dialogue.AddSentence("Moi", "Elle est souvent pratiquée pour traiter le syndrome de Rasmussen ou alléger les crises d'épilepsie.", 8);
                dialogue.AddSentence("Moi", "Attends, comment je sais tout ça moi?", 4);
                dialogue.AddSentence("Voix mystérieuse", "Elle n'a plus jamais été pareille,", 5);
                ...
                dialogue.AddSentence("Voix mystérieuse", "Vous voyez John, vous avez laissé vos docteurs se déchaîner dans votre hôpital,", 6);
                ...
                dialogue.AddSentence("Voix mystérieuse", "c'était MA Joséphine.", 4);
                dialogue.AddSentence("Voix mystérieuse", "Vous allez payer pour ce que vous avez fait.", 4);
